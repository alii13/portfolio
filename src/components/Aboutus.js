...
function Aboutus() {
    ...
    useEffect(()=>{
        ...
        z3
        .from([textWordsp1,textWordsp3], {duration: 0.6,
           opacity:0, scale:0, y:80,
            scrollTrigger:{
             ...
             rotationX:180, transformOrigin:"0% 50% -50",  ease:"back", stagger: 0.07},"-0.1")
        ...
        .from([textWordsp5,textWordsp7], {duration: 0.6,
            opacity:0, scale:0, y:80,
            delay:2,
             scrollTrigger:{
                 trigger:".trigger2",
...
<p ref={(el)=>{p3=el}} className="text-muted text-left">
Here are a few technologies I've been working with recently:
</p>
...
<p ref={(el)=>{p7=el}} className="text-muted text-left">
Here are a few technologies I've been working with recently:
</p>
<ul className="list text-muted">
    <li>JavaScript</li>
